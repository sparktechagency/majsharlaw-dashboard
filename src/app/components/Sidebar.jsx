...
const settingsItems =
  userRole === "admin"
    ? [
        { name: "Change Password", href: "/admin/profile", icon: KeyIcon },
        {
          name: "Privacy Policy",
        ...
        },
        {
          ...
          href: "/admin/settings/terms-&-conditions",
          icon: Info,
        },
        { name: "About Us", href: "/admin/settings/about-us", icon: Info },
      ]
    : [{ name: "Change Password", href: "/company/profile", icon: KeyIcon }];
    ...
    <>
      ...
      >
        <div className="flex flex-col h-full justify-between">
          ...
          {/* Navigation Items */}
          <nav className="mt-4 flex flex-col justify-between py-4 h-full">
            <div className="space-y-6">
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center justify-start pl-4 ${
                      userRole === "admin" ? "pr-20" : "pr-7"
                    } mx-auto py-2 transition-all rounded hover:bg-black/20 hover:text-[#6DA40A] ${
                      isActive ? "bg-white text-[#6DA40A]" : "text-[#D2D2D2]"
                    }`}
                  >
              ...
              <div>
                <button
                  ...
                  className={`flex items-center justify-between pl-4 pr-4 mx-auto py-2 w-full transition-all rounded hover:bg-black/20 hover:text-[#6DA40A] cursor-pointer ${
              ...
              {isDropdownOpen && (
                <div className="ml-4 mt-2 flex flex-col gap-1">
                  {settingsItems.map(({ name, href, icon: Icon }) => {
                    const isActive = pathname === href;
                    return (
                      <Link
                        key={name}
                        href={href}
                        className={`flex items-center justify-start p-2 transition-all rounded hover:bg-black/20 hover:text-[#6DA40A] ${
                          isActive
                            ? "bg-white text-[#6DA40A]"
                            : "text-[#D2D2D2]"
                        }`}
            ...
            {/* Logout Button */}
            <div className="border-[#D6D6D6] pt-6 pl-3">
