...
export default function LoginPage() {
  ...
  return (
    <div className="bg-white text-black min-h-screen flex items-center justify-center">
      <div className="w-1/3 p-10 border-[#FEFEFECC] shadow rounded-2xl mx-auto border flex flex-col items-center justify-center bg-white text-black">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 flex flex-col items-center justify-center">
          <div>
            <label
              htmlFor="email"
              className="block text-[#232323] font-medium mb-2"
            >
              Email
            </label>
            <input
              type="email"
              id="email"
              className="w-[450px] h-[51px] p-3 text-[#232323] rounded-lg border border-[#E0E0E0] focus:outline-none focus:ring-2"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                id="password"
                className="w-[450px] h-[51px] p-3 pr-10 text-[#232323] rounded-[6px] border border-[#E0E0E0] focus:outline-none focus:ring-2"
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 pr-3 text-[#232323] flex items-center text-sm leading-5 cursor-pointer"
              >
                {showPassword ? (
                  // eye icon
          ...
          <div className="flex justify-between gap-30">
            <div className="flex items-center gap-1">
              ...
              <label htmlFor="terms" className="text-[#232323]">Remember Password</label>
            </div>
            <Link
