    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg w-full max-w-md">
        ...
        <div className="bg-[#6DA40A] text-white p-4 rounded-t-lg flex items-center justify-between">
          <h2 className="text-lg font-medium">Add new provider</h2>
          <button
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <input
                ...
                className="px-4 py-3 bg-gray-100 border-0 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#6ea40ab6] placeholder-gray-600"
              />
              <input
                type="text"
                name="state"
